...
mkdir -p models/ensemble_balanced3/validation-fold-2_test-fold-3

# Copy over files
i=0
all_models=$(find ./models/ -wholename "*ensemble_balanced3_part*model-0")
for model in $all_models; do mv $model/ ./models/ensemble_balanced3/validation-fold-2_test-fold-3/model-$i; i=$(($i+1)); done
