...
def main():
    ...
    parser.add_argument('--architecture', type=str, default="CNN_LSTM_integrated_bidirectional")
    parser.add_argument('--evidential', type=bool, default=True)
    ...
    parser.add_argument('--reduce_learning_rate', type=bool, default=True)
    ...
    if args.evidential:
        args.architecture += "_"+ "evidential"
